// this file has bugs
// this file give result difference each time it run, coz from many simutaneously call to wrapHtmlParser(body,i)
// that function create dom may be it try to save memory it use sigle static variable to do this operation
